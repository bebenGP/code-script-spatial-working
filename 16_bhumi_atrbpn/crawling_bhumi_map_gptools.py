...
output_json_folder = arcpy.GetParameter(0) #r"C:\Users\bputra\OneDrive - ESRI Indonesia\PT ESRI Indonesia\Research\code-script\16_bhumi_atrbpn\data"
###################################--------------------------------################################--------------------------------################################
#ArcGIS Processing input/output
folder = f"{output_json_folder}" #r"C:\Users\bputra\OneDrive - ESRI Indonesia\PT ESRI Indonesia\Research\code-script\16_bhumi_atrbpn\data"
folder_shp = arcpy.GetParameter(1)  #r"C:\Users\bputra\OneDrive - ESRI Indonesia\PT ESRI Indonesia\Research\code-script\16_bhumi_atrbpn\data_shp"
arcpy.env.workspace = output_json_folder
# Define output folder
output_folder = arcpy.GetParameter(2) #r"C:\Users\bputra\OneDrive - ESRI Indonesia\PT ESRI Indonesia\Research\code-script\16_bhumi_atrbpn\output"
# Create a scratch geodatabase for temporary storage
#scratch_gdb = arcpy.env.scratchGDB
name_file_cleaned = arcpy.GetParameterAsText(3)
...
def processing_raw_json(folder_env, folder_output_shp, folder_clean_data) :
    ...
    cleaned_output = os.path.join(folder_clean_data, str(name_file_cleaned)) #name_file_cleaned = string
...
time.sleep(5)
processing_raw_json(folder_env=output_json_folder, folder_output_shp=folder_shp, folder_clean_data=output_folder)
