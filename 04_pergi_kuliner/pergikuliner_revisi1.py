...
output_directory = r"C:\Users\bputra\OneDrive - ESRI Indonesia\Data Services\raw-need-cleansing\pergi_kuliner\output_pergi_kuliner_beben\output_pergi_kuliner"
csv_file_path = f"{output_directory}\\restaurant_data_testing999.csv"
...
with open(csv_file_path, 'w', newline='', encoding='utf-8') as csvfile:
    ...
    for id_number in range(114773, 148671):
        ...
        headers = {
            'Authorization': 'Token token=M2Y0ODI4ZDZmNzM5ZmIzNjM4N2QwYjk4NmZlMzlhZjMsIDE2OTE0MjExODA=',
